...
class User {
    ...
    constructor(firstName, lastName, username, age, password, mobNumber, accountNumber, balance, identityCard) {
...
class Bank {
    users; //store registered user in array
    balance; //Balance that in the bank
    logedInUser; //checks currentlty user logged in or not
    constructor() {
        this.users = [];
        this.balance = 0;
